...
export default function Newsletter() {
  ...
  return (
    <section className="newsletter-section relative overflow-hidden bg-[#0d0d0d] py-24 px-6">
      {/* Grain texture overlay */}
      <div className="newsletter-grain" aria-hidden="true" />

      <div className="relative z-10 mx-auto max-w-2xl text-center">
        {/* Eyebrow */}
        <p className="mb-4 text-[11px] font-medium uppercase tracking-[0.35em] text-[var(--color-accent)]">
          Newsletter
        </p>

        {/* Heading */}
        <h2 className="mb-4 text-3xl font-bold uppercase tracking-[0.06em] text-[var(--color-off-white)] md:text-4xl">
          Stay in the Loop
        </h2>
          ...
          {submitted ? (
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="h-12 shrink-0 bg-[var(--color-accent)] px-8 text-[12px] font-bold uppercase tracking-[0.2em] text-[var(--color-black)] transition-opacity hover:opacity-85 disabled:opacity-60"
              >
                {loading ? "..." : "Subscribe"}
              </button>
            </motion.form>
